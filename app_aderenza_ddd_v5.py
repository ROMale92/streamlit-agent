...
if file_disp and file_ddd:
    ...
    if submitted:
        ...
        aderenza = aderenza.rename(columns={
            "giorni_copertura": "Copertura",
            "prima_data": "Prima_disp",
            date_col: "Ultima_disp",
            atc_col: "ATC_principale"
        })

        # CALCOLO DURATA: usa il periodo scelto dall'utente
        aderenza["Durata_reale"] = (aderenza["Ultima_disp"] - aderenza["Prima_disp"]).dt.days + 1
        aderenza["Durata"] = periodo
        aderenza["PDC"] = aderenza["Copertura"] / aderenza["Durata"]
        ...
        # GRAFICO DISTRIBUZIONE PDC
        st.subheader("📈 Distribuzione PDC")
        fig = px.histogram(aderenza, x="PDC", nbins=20, title="Distribuzione del PDC")
