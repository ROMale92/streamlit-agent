    ...
    if submitted:
        ...
        if df.empty:
            ...
            if max_line < 2:
                ...
                # Rimuovi righe con valori non presenti in all_labels (sicurezza)
                sankey_df = sankey_df[
                    sankey_df[sankey_df.columns[0]].isin(all_labels) &
                    sankey_df[sankey_df.columns[1]].isin(all_labels)
                ]
