...
if file:
    ...
    if submit:
        ...
        # Calcolo esito: in trattamento o perso al follow-up
        ...
        all_labels = pd.concat([sankey_df[col] for col in sankey_df.columns[:2]]).unique().tolist()
